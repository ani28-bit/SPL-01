 ...
 public class GAPlotGAvsCPLEX {
    ...
    public static void main(String[] args) {
        ...
        if (cplexTour.isEmpty()) { 
            ...
            cplexTour = new ArrayList<>(gaTour); 
             Collections.reverse(cplexTour);
        ...
        String title = optimal
            ? "GA vs CPLEX  |  GA found OPTIMAL solution!  Gap: 0.00%"
            : String.format("GA vs CPLEX  |  Optimality Gap: %.2f%%  (CPLEX optimal)", gap);
        ...
        String gaTag = optimal ? "  ★ OPTIMAL" : String.format("  [Gap: %.2f%%]", gap);
        ...
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("GA TSP — GA vs CPLEX");
