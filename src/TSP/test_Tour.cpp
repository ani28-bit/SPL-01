...
void testSwapCities() {
    ...
    cout << "\nSwapping cities at index 1 and 3..." << endl;
    tour.swapCities(1, 3);
    tour.printTour();
}
...
void testCopyConstructor() {
    ...
    // Modify original
    cout << "\nAdding city to original tour..." << endl;
    City c4(4, 10, 12);
    tour1.addCity(c4);
    ...
    cout << "\nCopied tour (should be unchanged):" << endl;
    tour2.printTour();
}

void testAssignmentOperator() {
    cout << "\nTEST 6: Assignment Operator" << endl;
    printSeparator();
...
void testValidation() {
    ...
    // Empty tour
    cout << "Empty tour is valid? " << (tour.isValid() ? "Yes" : "No") << endl;
    ...
    cout << "Tour with 3 cities is valid? " << (tour.isValid() ? "Yes" : "No") << endl;
    
    // Check if contains city
    cout << "Contains city with ID 2? " << (tour.containsCity(c2) ? "Yes" : "No") << endl;
    
    City c4(4, 10, 10);
    cout << "Contains city with ID 4? " << (tour.containsCity(c4) ? "Yes" : "No") << endl;
}
...
void testComparison() {
    ...
    tour1.addCity(c1);
    tour1.addCity(c2);
    tour1.addCity(c1);  // Return to start
    ...
    cout << "\nComparisons:" << endl;
    cout << "Tour1 < Tour2: " << (tour1 < tour2 ? "True" : "False") << endl;
    cout << "Tour1 > Tour2: " << (tour1 > tour2 ? "True" : "False") << endl;
    cout << "Tour1 == Tour2: " << (tour1 == tour2 ? "True" : "False") << endl;
}

void testClear() {
    cout << "\nTEST 9: Clear Tour" << endl;
    printSeparator();
...
void testErrorHandling() {
    ...
    for (int i = 0; i < 102; i++) {
        ...
        if (!bigTour.addCity(c)) {
            cout << "Failed to add city " << i << " (limit reached)" << endl;
            break;
        }
    }
}
...
void testRealWorldScenario() {
    ...
    // Create a simple 5-city tour
    City cities[5] = {
        City(1, 0, 0),    // Origin
        City(2, 4, 0),    // East
        City(3, 4, 3),    // Northeast
        City(4, 0, 3),    // North
        City(5, 2, 1.5)   // Center
    };
    ...
    if (newDistance < oldDistance) {
        cout << "Improvement! Distance reduced by: " 
             << (oldDistance - newDistance) << endl;
    } else {
        cout << "No improvement. Distance increased by: " 
             << (newDistance - oldDistance) << endl;
    }
}

int main() {
    cout << "\n****************************************" << endl;
    cout << "*     TOUR CLASS TESTING SUITE        *" << endl;
    cout << "****************************************" << endl;
