...
public class GAPlotAll {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < bestTour.size(); i++) {
            ...
            if (c != null) {
                ...
                System.err.println("WARNING: City ID " + cityId + " not found in cities list!");
            }
        }
        ...
        // Renderer for line + bigger points
    ...
    // Load city coordinates from cities.txt
    private static ArrayList<City> loadCities(String filename) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filename))) {
            ...
            System.err.println("ERROR reading cities.txt: " + e.getMessage());
            e.printStackTrace(); 
        }
        return cities;
    }

    // Load best tour from ga_results.csv
            ...
            while ((line = br.readLine()) != null) {
                if (line.startsWith("Final Best Tour")) {
                    ...
                    if (tourStart >= 0 && pipe > tourStart) {
                        // Extract tour string between "Tour:" and "|"
                        String tourStr = line.substring(tourStart + 5, pipe).trim();
                        
                        // Remove "Tour:" if it's still in the string
                        ...
                        // Ensure tour is closed (last city = first city)
